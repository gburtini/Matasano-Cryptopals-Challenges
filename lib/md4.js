 ...
 */
function hex_md4(s, as = [1732584193, -271733879, -1732584194, 271733878], overrideLength = 0) {
  return binl2hex(core_md4(str2binl(s), s.length * chrsz, as, overrideLength));
}
function b64_md4(s) {
  return binl2b64(core_md4(str2binl(s), s.length * chrsz));
}
function str_md4(s, as = [1732584193, -271733879, -1732584194, 271733878], overrideLength = 0) {
  return binl2str(core_md4(str2binl(s), s.length * chrsz, as, overrideLength));
}
 ...
 */
function core_md4(x, len, [a, b, c, d], overrideLength = 0) {
  /* append padding */
  if (overrideLength === 0) overrideLength = len;
  x[len >> 5] |= 0x80 << overrideLength % 32;
  x[(((len + 64) >>> 9) << 4) + 14] = overrideLength;
...
function core_hmac_md4(key, data) {
  ...
  const hash = core_md4(ipad.concat(str2binl(data)), 512 + data.length * chrsz);
