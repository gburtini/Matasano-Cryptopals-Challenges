...
function hex_md4(s, as = [1732584193, -271733879, -1732584194, 271733878], overrideLength = 0) {
  const result = core_md4(str2binl(s), (overrideLength + s.length) * chrsz, as);
...
function str_md4(s, as = [1732584193, -271733879, -1732584194, 271733878], overrideLength = 0) {
  return binl2str(core_md4(str2binl(s), (overrideLength + s.length) * chrsz, as));
}
 ...
 */
function core_md4(x, len, [a, b, c, d]) {
  /* append padding */
