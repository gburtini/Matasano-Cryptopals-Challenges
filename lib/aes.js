...
const { chunk, naiveStringToBytes } = require('./stream');
...
module.exports = {
  ...
  encrypt: {
    ...
    ctr: aesLambda.bind(this, key => new aesjs.ModeOfOperation.ctr(key), 'encrypt'),
  },
  decrypt: {
    ...
    ctr: aesLambda.bind(this, key => new aesjs.ModeOfOperation.ctr(key), 'decrypt'),
  },
};
